...
public class Insulter implements TriggerListener {
    ...
    public void onTrigger(String channel, String sender, String login, String hostname, String message, String trigger) {
        ...
        try {
            ...
            if(insulted != null) {
                bot.sendMessage(insulted + ": " + insult);
            } else {
                bot.sendMessage(insult);
            }
        } catch(IOException e) {
            if(insulted != null) {
                bot.sendMessage("Sorry, " + insulted + "'s ghastly presence made me throw up an IOException.");
            } else {
                bot.sendMessage("Sorry, your ghastly presence made me throw up an IOException.");
            }
            e.printStackTrace();
        } catch (JDOMException e) {
            if(insulted != null) {
                bot.sendMessage("Sorry, " + insulted + "'s ghastly presence made me throw up a JDOMException.");
            } else {
                bot.sendMessage("Sorry, your ghastly presence made me throw up a JDOMException.");
            }
            e.printStackTrace();
        }
    }
